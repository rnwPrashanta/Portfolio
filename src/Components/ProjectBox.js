...
const  ProjectBox = ({projectPhoto, projectName}) => {
  const desc = {
    ...
    SimonSaysGameDesc:"Secure user login by email and password or third-party providers like Google is made possible using React authentication with Firebase. Security, token management, and user sessions are handled by Firebase Authentication. Google login makes the procedure easy and safe by allowing users to authenticate using their Google account. 🚀.",
    SimonSaysGameGithub:"https://github.com/rnwPrashanta/Simon-Says-Game",
    SimonSaysGameWebsite:"https://simon-says-game-bay.vercel.app/",
